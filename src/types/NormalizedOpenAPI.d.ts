/**
 * Open APIの型定義を変更し、refを必ずたどるようにする
 * V3のみサポート
 *
 * 元の定義:
...
export namespace NormalizedOpenAPI {
  ...
  export type Document<T extends {} = {}> =
    ...
    | NormalizedOpenAPIV3.Document<T>
    | OpenAPIV3_1.Document<T>;
  export type Operation<T extends {} = {}> =
    | OpenAPIV2.OperationObject<T>
    | NormalizedOpenAPIV3.OperationObject<T>
    | OpenAPIV3_1.OperationObject<T>;
  export type Parameter =
    | OpenAPIV3_1.ReferenceObject
    | OpenAPIV3_1.ParameterObject
    | NormalizedOpenAPIV3.ReferenceObject
    | NormalizedOpenAPIV3.ParameterObject
    | OpenAPIV2.ReferenceObject
    | OpenAPIV2.Parameter;
  export type Parameters =
    | (OpenAPIV3_1.ReferenceObject | OpenAPIV3_1.ParameterObject)[]
    | (NormalizedOpenAPIV3.ReferenceObject | NormalizedOpenAPIV3.ParameterObject)[]
...
export namespace OpenAPIV3_1 {
  ...
  export type Document<T extends {} = {}> = Modify<
    Omit<NormalizedOpenAPIV3.Document<T>, "paths" | "components">,
    {
      info: InfoObject;
  ...
  export type InfoObject = Modify<
    NormalizedOpenAPIV3.InfoObject,
    {
      summary?: string;
  ...
  export type ContactObject = NormalizedOpenAPIV3.ContactObject;

  export type LicenseObject = Modify<
    NormalizedOpenAPIV3.LicenseObject,
    {
      identifier?: string;
    }
  >;
  ...
  export type ServerObject = Modify<
    NormalizedOpenAPIV3.ServerObject,
    {
      url: string;
      description?: string;
  ...
  export type ServerVariableObject = Modify<
    NormalizedOpenAPIV3.ServerVariableObject,
    {
      enum?: [string, ...string[]];
    }
  >;
  ...
  export type HttpMethods = NormalizedOpenAPIV3.HttpMethods;

  export type PathItemObject<T extends {} = {}> = Modify<
    NormalizedOpenAPIV3.PathItemObject<T>,
    {
      servers?: ServerObject[];
  ...
  export type ExternalDocumentationObject = NormalizedOpenAPIV3.ExternalDocumentationObject;

  export type ParameterObject = NormalizedOpenAPIV3.ParameterObject;

  export type HeaderObject = NormalizedOpenAPIV3.HeaderObject;

  export type ParameterBaseObject = NormalizedOpenAPIV3.ParameterBaseObject;

  export type NonArraySchemaObjectType = NormalizedOpenAPIV3.NonArraySchemaObjectType | "null";

  export type ArraySchemaObjectType = NormalizedOpenAPIV3.ArraySchemaObjectType;
  ...
  export type BaseSchemaObject = Modify<
    Omit<NormalizedOpenAPIV3.BaseSchemaObject, "nullable">,
    {
      examples?: NormalizedOpenAPIV3.BaseSchemaObject["example"][];
  ...
  export type DiscriminatorObject = NormalizedOpenAPIV3.DiscriminatorObject;

  export type XMLObject = NormalizedOpenAPIV3.XMLObject;
  ...
  export type ExampleObject = NormalizedOpenAPIV3.ExampleObject;

  export type MediaTypeObject = Modify<
    NormalizedOpenAPIV3.MediaTypeObject,
    {
  ...
  export type EncodingObject = NormalizedOpenAPIV3.EncodingObject;

  export type RequestBodyObject = Modify<
    NormalizedOpenAPIV3.RequestBodyObject,
    {
      content: { [media: string]: MediaTypeObject };
    }
  >;

  export type ResponsesObject = Record<string, ReferenceObject>;

  export type ResponseObject = Modify<
    NormalizedOpenAPIV3.ResponseObject,
    {
  ...
  export type LinkObject = Modify<
    NormalizedOpenAPIV3.LinkObject,
    {
      server?: ServerObject;
    }
  >;
  ...
  export type SecurityRequirementObject = NormalizedOpenAPIV3.SecurityRequirementObject;

  export type ComponentsObject = Modify<
    NormalizedOpenAPIV3.ComponentsObject,
    {
  ...
  export type SecuritySchemeObject = NormalizedOpenAPIV3.SecuritySchemeObject;

  export type HttpSecurityScheme = NormalizedOpenAPIV3.HttpSecurityScheme;

  export type ApiKeySecurityScheme = NormalizedOpenAPIV3.ApiKeySecurityScheme;

  export type OAuth2SecurityScheme = NormalizedOpenAPIV3.OAuth2SecurityScheme;

  export type OpenIdSecurityScheme = NormalizedOpenAPIV3.OpenIdSecurityScheme;

  export type TagObject = NormalizedOpenAPIV3.TagObject;
}

export namespace NormalizedOpenAPIV3 {
  ...
  //     for (const method of Object.values(NormalizedOpenAPIV3.HttpMethods)) { … }
  ...
  export type OperationObject<T extends {} = {}> = {
    ...
    responses: ResponsesObject;
    callbacks?: { [callback: string]: ReferenceObject };
    deprecated?: boolean;
    security?: SecurityRequirementObject[];
    servers?: ServerObject[];
  } & T;
